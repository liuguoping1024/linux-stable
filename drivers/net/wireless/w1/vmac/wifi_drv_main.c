...
{
    printk("drv_set_cfg_tx_power_limit cfg_txpowlimit:%d\n",cfg_txpowlimit);
...
drv_update_tx_pwr(struct drv_private *drv_priv, unsigned short txpowerdb)
{
    ...
    printk("---drv_update_tx_pwr drv_curtxpower:%d\n",drv_priv->drv_curtxpower);
}
    ...
    unsigned int limit, unsigned short txpowerdb)
{
    ...
    printk("drv_set_tx_pwr_limit txpowerdb:%d\n",txpowerdb);
