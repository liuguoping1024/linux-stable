...
#if LINUX_VERSION_CODE < KERNEL_VERSION(5,19,0)
static  int vm_cfg80211_add_key(struct wiphy *wiphy, struct net_device *dev, u8 key_index,
    ...
    struct cfg80211_mgmt_tx_params *params, unsigned long long *cookie)
{
    ...
    printk("vm_cfg80211_mgmt_tx: opmode %d, p2p_support %d, ret %d\n", wnet_vif->vm_opmode, wnet_vif->vm_p2p_support, ret);
...
char *rssi_result_path = "/lib/firmware/w1/rssi.tx";
